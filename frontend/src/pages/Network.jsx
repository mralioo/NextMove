    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: '16px', height: '100%', overflowY: 'auto' }}>
      ...
      <div className="card" style={{ padding: '0', overflow: 'hidden', height: '480px', minHeight: '480px', position: 'relative' }}>
        ...
        <div style={{
          height: '100%',
          width: '100%',
          filter: darkTiles ? 'invert(98%) hue-rotate(185deg) brightness(88%) contrast(110%)' : 'none',
          ...
          <div>
            ...
            <p style={{ margin: '2px 0 0 0', fontSize: '0.75rem', color: 'var(--text-muted)' }}>
              {isSingleLine
                ...
                : `Showing TOP 20 stations across selected lines (00:00 - 23:00) · Dark = Normal, Gold = Peak`}
            </p>
          </div>
